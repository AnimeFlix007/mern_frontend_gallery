...
export const uploadImage = createAsyncThunk(
  ...
  async (image, { rejectWithValue }) => {
    try {
      ...
      const res = await axios.post("https://mern-gallery-anime-backend.onrender.com/api/gallery/", image, config);
...
export const deleteImage = createAsyncThunk(
  ...
  async (imageId, { rejectWithValue }) => {
    ...
    try {
      const res = await axios.delete(`https://mern-gallery-anime-backend.onrender.com/api/gallery/${imageId}`, config);
      return res.data;
    } catch (error) {
      if (!error && !error?.response) {
        throw error;
...
export const getAllImages = createAsyncThunk(
  ...
  async (image, { rejectWithValue }) => {
    ...
    try {
      const res = await axios.get("https://mern-gallery-anime-backend.onrender.com/api/users/getallphotos", config);
